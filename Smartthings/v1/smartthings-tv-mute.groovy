...
metadata {
	definition (name: "TV-Mute", namespace: "TV", author: "Victor Santana") {
		capability "Actuator"
		capability "Switch"
	...
	tiles {
		standardTile("switch", "device.switch", width: 2, height: 2, canChangeIcon: true) {
			state "off", label: 'off', action: "on", icon: "st.quirky.spotter.quirky-spotter-sound-off", backgroundColor: "#ffffff", nextState: "Turning on"
			state "on", label: 'on', action: "off", icon: "st.quirky.spotter.quirky-spotter-sound-off", backgroundColor: "#00A0DC"
		}
		main "switch"
		details "switch"
	}
